...
public class EitherImpl<A,B> implements Either<A,B> {
    ...
    public EitherImpl(Optional<A> failurePart, Optional<B> successPart) {
    ...
    public boolean isSuccess() {
        return this.successPart.isPresent();
    }
    ...
    public <B1> Either <A, B1> map(Function<B, B1> function) {
        return fold(EitherImpl :: createFailure, function.andThen(EitherImpl:: createSuccess));
    }
